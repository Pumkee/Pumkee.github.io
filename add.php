<?php
    ...
    //require("/Applications/MAMP/htdocs/pumkee.github.io/database.php");
...
$htmlemail= "./htmlemail.php";
$message= file_get_contents($htmlemail);

$swap_var= array(
    "{CSS_FILE}"=> "assets/css/styles.css",
    "{EMAIL_IMAGE}" => "assets/img/LOGO PUMKEE (5).png",
    "{NAME}"=> "$name"
...
$mail->Port=465;
$mail->isHTML();
$mail->Username="pumkee.co@gmail.com";
$mail->Password="ColUsa2021@";
$mail->AddReplyTo('pumkee.co@gmail.com', 'Pumkee');
$mail->AddAddress($email, $name);
$mail->SetFrom('pumkee.co@gmail.com', 'Pumkee');
