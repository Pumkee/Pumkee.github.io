    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                ...
                <a href="#" class="nav__logo"><img width="100px" height="150px" src="assets/img/LOGO PUMKEE (5).png"></a>
                    ...
                    <div class="send__content">
                        ...
                        <form action="add.php" method="POST" >
                            <div class="send__direction">
                                <input type="text" name="name" placeholder="Type your name here" class="send__input" >
                            </div><br>
                            <div class="send__direction">
                                <input type="email" name="email" placeholder="Type your email here" class="send__input">
                                <button type="submit" name="submit" name="name" class="button" value="Join!">Join!</button>
            ...
            <div class="footer__container bd-container bd-grid">
                <div class="footer__content">
                    <h3 class="footer__title">
                        <a href="#home" class="footer__logo"><img src="assets/img/LOGO PUMKEE (6).png"></a>
                    </h3>
